...
contract InitializeL2ScrollOwner is Script {
    ...
    function configL2TxFeeVault() internal {
        ...
        _selectors[0] = FeeVault.updateMinWithdrawAmount.selector;
    ...
    function configL2GatewayRouter() internal {
        ...
        owner.updateAccess(L2_GATEWAY_ROUTER_PROXY_ADDR, _selectors, TIMELOCK_7DAY_DELAY_ROLE, true);
    }
    ...
    function configL2ERC721Gateway() internal {
        ...
        owner.updateAccess(L2_ERC721_GATEWAY_PROXY_ADDR, _selectors, TIMELOCK_7DAY_DELAY_ROLE, true);
    }
