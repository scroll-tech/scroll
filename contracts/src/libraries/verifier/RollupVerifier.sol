...
library RollupVerifier {
    ...
    )
  {
    ...
    update_hash_scalar(9041251678832252462276167704948301954775106914454606584016914679968512645752, absorbing, 0);
    ...
    (t0, t1) = (
      ecc_mul_add(
        6868934740744879126573408541524133123766016938272720307545725559017587249613,
    ...
    (t0, t1) = (
      ecc_mul_add(
        ...
        21308834176879780815187404163906383811133132848629353971379202978446381827940,
        m[76],
        t0,
        t1
      )
    ...
    (t0, t1) = (
      ecc_mul_add(
        13269790231923767167209926893407546365721915640178305356236368092090668185348,
    ...
    (t0, t1) = (
      ecc_mul_add(
        ...
        8036846519675806652417921710615138945583855033542265333729541855571709721900,
        m[74],
        t0,
        t1
      )
    ...
    (t0, t1) = (
      ecc_mul_add(
        6241696953714051169624307504843007542964395732925744261127384402163115057597,
    ...
    (t0, t1) = (
      ecc_mul_add(
        ...
        18001521016317289264471247148935243461366273627431441720522923389477173226482,
        m[69],
        t0,
        t1
      )
    ...
    (t0, t1) = (
      ecc_mul_add(
        10937446292077070729558153487785987613622069784306547513629328604503647915357,
        6273888793400372489088525589714098650686762995992388043440762837989023765476,
        m[67],
        t0,
        t1
      )
    ...
    (t0, t1) = (
      ecc_mul_add(
        ...
        9726715848732746770175347136601925983847710318489343288334446618334500425063,
        m[65],
        t0,
        t1
      )
    ...
    (t0, t1) = (
      ecc_mul_add(
        ...
        14249257112373879531360174752116712311645592128527719431361763525909415537977,
        m[64],
        t0,
        t1
      )
    ...
    (t0, t1) = (
      ecc_mul_add(
        8300430797902002046014838065113316554545790383542348581265135223250762623925,
        17024482413122062320242571556337044808131892111554495327780045155681579869925,
        m[63],
        t0,
        t1
      )
    ...
    (t0, t1) = (
      ecc_mul_add(
        15631691377468364022801992121599321102430920478623161647366100163795621199510,
    ...
    (t0, t1) = (
      ecc_mul_add(
        9851970108002877638147263885545876947139684654910580315658033952655239106855,
    ...
    (t0, t1) = (
      ecc_mul_add(
        16983481690804455262021586409023353170937559044471905873068647148078270425230,
