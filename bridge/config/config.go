...
func NewConfig(file string) (*Config, error) {
	...
	cfg.DBConfig.DSN = db_config.GetEnvWithDefault("DB_DSN", cfg.DBConfig.DSN)
	cfg.DBConfig.DriverName = db_config.GetEnvWithDefault("DB_DRIVER", cfg.DBConfig.DriverName)
