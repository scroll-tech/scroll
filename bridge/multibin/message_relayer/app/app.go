...
import (
	...
	messagerelayer "scroll-tech/bridge/multibin/message_relayer"
)
...
func action(ctx *cli.Context) error {
	...
	l1relayer, err = messagerelayer.NewL1MsgRelayer(ctx.Context, cfg.L1Config.Confirmations.Int64(), ormFactory, cfg.L1Config.RelayerConfig)
	if err != nil {
