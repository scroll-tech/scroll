...
import (
	...
	batchProposer "scroll-tech/bridge/watcher/batch_proposer"
)
...
type WatcherClient struct {
	...
	*ethclient.Client
	...
	batchProposer *batchProposer.BatchProposer
}
...
func NewL2WatcherClient(ctx context.Context, client *ethclient.Client, confirmations rpc.BlockNumber, bpCfg *config.BatchProposerConfig, messengerAddress common.Address, orm database.OrmFactory) *WatcherClient {
	...
	return &WatcherClient{
		...
		stopped:            0,
		batchProposer:      batchProposer.NewBatchProposer(bpCfg, orm),
	}
}
...
func (w *WatcherClient) GetBatchProposer() *batchProposer.BatchProposer {
