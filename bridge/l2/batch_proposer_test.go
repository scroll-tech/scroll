...
func testBatchProposerProposeBatch(t *testing.T) {
	...
	assert.NoError(t, db.InsertL2BlockTraces([]*types.BlockWithWithdrawTrieRoot{blockWithWithdrawTrieRoot1}))
...
func testBatchProposerGracefulRestart(t *testing.T) {
	...
	// Insert traces into db.
	assert.NoError(t, db.InsertL2BlockTraces([]*types.BlockWithWithdrawTrieRoot{blockWithWithdrawTrieRoot2}))
