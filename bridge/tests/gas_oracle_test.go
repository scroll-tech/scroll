...
func testImportL1GasPrice(t *testing.T) {
	...
	assert.NoError(t, err)
	l1Watcher := watcher.NewL1Watcher(context.Background(), l1Client, startHeight-1, 0, l1Cfg.L1MessengerAddress, l1Cfg.L1MessageQueueAddress, l1Cfg.ScrollChainContractAddress, db)
