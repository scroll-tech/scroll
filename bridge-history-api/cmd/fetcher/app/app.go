...
func action(ctx *cli.Context) error {
	...
	l1MessageFetcher := fetcher.NewL1MessageFetcher(subCtx, cfg.L1, db, l1Client, syncInfo)
	go l1MessageFetcher.Start()

	l2MessageFetcher := fetcher.NewL2MessageFetcher(subCtx, cfg.L2, db, l2Client, syncInfo)
