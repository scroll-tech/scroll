...
create unique index uq_layer1_hash_layer2_hash
...
CREATE INDEX valid_l1_msg_index ON cross_message (layer1_hash, deleted_at);

CREATE INDEX valid_l2_msg_index ON cross_message (layer2_hash, deleted_at);

CREATE INDEX valid_height_index ON cross_message (height, msg_type, deleted_at);
