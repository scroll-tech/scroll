...
CREATE UNIQUE INDEX IF NOT EXISTS idx_bbde_message_hash ON bridge_batch_deposit_event_v2 (message_hash);
...
CREATE INDEX IF NOT EXISTS idx_bbde_l1_tx_hash ON bridge_batch_deposit_event_v2 (l1_tx_hash);
