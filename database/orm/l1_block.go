...
func (l *l1BlockOrm) GetL1BlockInfos(fields map[string]interface{}, args ...string) ([]*L1BlockInfo, error) {
...
func (l *l1BlockOrm) InsertL1Blocks(ctx context.Context, blocks []*L1BlockInfo) error {
	if len(blocks) == 0 {
		return nil
	}
	...
	_, err := l.db.NamedExec(`INSERT INTO public.l1_block (number, hash, header_rlp) VALUES (:number, :hash, :header_rlp);`, blockMaps)
	if err != nil {
...
func (l *l1BlockOrm) UpdateL1BlockStatus(ctx context.Context, blockHash string, status L1BlockStatus) error {
...
func (l *l1BlockOrm) UpdateL1BlockStatusAndImportTxHash(ctx context.Context, blockHash string, status L1BlockStatus, txHash string) error {
