        ...
        stage('Test') {
            ...
            steps {
               ...
               catchError(buildResult: 'FAILURE', stageResult: 'FAILURE') {
                    sh '''
                        go test -v -race -coverprofile=coverage.txt -covermode=atomic -p 4 scroll-tech/database/...
                        go test -v -race -coverprofile=coverage.txt -covermode=atomic -p 4 scroll-tech/bridge/...
                        go test -v -race -coverprofile=coverage.txt -covermode=atomic -p 4 scroll-tech/common/...
                        go test -v -race -coverprofile=coverage.txt -covermode=atomic -p 4 scroll-tech/coordinator/...
                        cd ..
                    '''
                    script {
