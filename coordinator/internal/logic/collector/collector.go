...
func (b *BaseCollector) sendTask(proveType message.ProofType, hash string, blockHashes []common.Hash, subProofs []*message.BatchProof) ([]*coordinatorType.ProverStatus, error) {
